...
\usepackage{booktabs}
\usepackage{listings}
\lstdefinestyle{indentedCommand}{
	language=Bash,
	numbers=none,
	numbersep=10pt,
	tabsize=4,
...
Die von ihr verwendete Schemas entsprechen deshalb denen der im Quelltext definierten Klassen (siehe \nameref{subsec:attachements:schemas}).
Falls die vorkonfigurierte MongoDB über Docker Compose verwendet wird, lassen sich Daten mit Hilfe zweier Kommandozeilenbefehle sichern und wiederherstellen.
