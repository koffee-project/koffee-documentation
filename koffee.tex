...
Auf der Statistikseite finden sich Angaben zu Anzahl und letzten Kaufzeitpunkten pro Artikel vom aktiven Nutzer (siehe \autoref{fig:app:architecture:functionality:statistics}).
...
\begin{figure}[]
	...
	\caption{Statistiken}
	\label{fig:app:architecture:functionality:statistics}
\end{figure}
%------------------------------------------------------------------------------------------------------------------------------------------------------
