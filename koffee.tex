...
\begin{enumerate}
	\item \verb|./gradlew build|
	\item Das benötigten Docker Secret anlegen (siehe \autoref{subsec:backend:configuration}).
	\item Den Wert von \verb|URL| in \verb|./environments/domain.env| auf eine valide Domäne ändern, über welche der Host erreichbar ist.
	\item Sicherstellen, dass der Host über die Ports 80 und 443 erreichbar ist.
