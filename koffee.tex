...
Die App verwendet die von Google empfohlene Architektur \autocite{androidarchitecture}.
...
JWTs werden nach erfolgreichen Logins mit validen Daten generiert, sind für 24 Stunden gültig und müssen bei jeder Anfrage für Administrator-Funktionen enthalten sein.
...
Während dem Start generiert das Backend einen Standard\-administrator, welcher zuvor festgelegte Daten besitzt (siehe \autoref{subsec:backend:configuration}).
%------------------------------------------------------------------------------------------------------------------------------------------------------
