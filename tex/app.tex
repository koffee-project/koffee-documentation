...
\begin{figure}%
	\centering
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/greetings-dialog.png}\label{fig:app:functionality:selection:dialog}}}%
	\qquad
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/user-search.png}\label{fig:app:functionality:selection:search}}}%
...
\begin{figure}%
	\centering
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/home-fragment.png}\label{fig:app:functionality:home:search}}}%
	\qquad
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/home-fragment-transaction.png}\label{fig:app:functionality:home:transaction}}}%
	\caption{Hauptseite}%
...
\begin{figure}%
	\centering
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/item-purchased.png}\label{fig:app:functionality:item:purchase}}}%
	\qquad
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/item-refunded.png}\label{fig:app:functionality:item:refund}}}%
...
\begin{figure}%
	\centering
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/history.png}\label{fig:app:functionality:history:history}}}%
	\qquad
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/statistics.png}\label{fig:app:functionality:history:statistics}}}%
...
\begin{figure}%
	\centering
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/settings-admin.png}\label{fig:app:functionality:settings:settings}}}%
	\qquad
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/login.png}\label{fig:app:functionality:settings:login}}}%
...
\begin{figure}%
	\centering
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/create-user.png}\label{fig:app:functionality:admin:create}}}%
	\qquad
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/user-admin-view.png}\label{fig:app:functionality:admin:user}}}%
	\qquad
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/crediting.png}\label{fig:app:functionality:admin:crediting}}}%
	\qquad
	\subfloat{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/edit-item.png}\label{fig:app:functionality:admin:edit}}}%
