...
\begin{figure}%
	\centering
	\subfloat[Einstellungen]{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/settings-admin.png}\label{fig:app:functionality:settings:settings}}}%
	\qquad
	\subfloat[Login]{{\includegraphics[height=8cm,keepaspectratio]{./img/screenshots/login.png}\label{fig:app:functionality:settings:login}}}%
