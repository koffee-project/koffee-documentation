...
Falls die über \textit{Docker Compose} vorkonfigurierte MongoDB verwendet wird, lassen sich Daten mit Hilfe zweier Kommandozeilenbefehle sichern und wiederherstellen (siehe \nameref{subsec:attachments:database}).
%------------------------------------------------------------------------------------------------------------------------------------------------------
