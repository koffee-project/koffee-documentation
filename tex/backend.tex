...
Alle Funktionen des Backends sind über eine Vielzahl von Routen verwendbar (siehe \autoref{subsec:attachments:routes}).
...
Die von ihr verwendete Schemas entsprechen deshalb denen der im Quelltext definierten Klassen (siehe \autoref{subsec:attachments:schemas}).
Falls die über \textit{Docker Compose} vorkonfigurierte MongoDB verwendet wird, lassen sich Daten mit Hilfe zweier Kommandozeilenbefehle sichern und wiederherstellen (siehe \autoref{subsec:attachments:database}).
%------------------------------------------------------------------------------------------------------------------------------------------------------
...
Schrittweise Anleitungen zur Inbetriebnahme befinden sich im Anhang (siehe \autoref{subsec:attachments:instructions}).
%------------------------------------------------------------------------------------------------------------------------------------------------------
